...
# Threading module for potential concurrent processing
import threading
...
# This allows sharing the frame between processing and display
latest_frame = None

# Main function to process video frames from the input stream
def process_frames():
    # Use global keyword to modify the global latest_frame variable
    global latest_frame
    ...
    while True:
        ...
        # Update the latest frame with the processed frame
        latest_frame = frame
